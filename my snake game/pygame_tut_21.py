...
pygame.display.set_caption("Snake with SATYAM")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("HELLO GUYS THIS IS SATYAM GUPTA", black,116, 210)
        text_screen("Welcome to my Snakes Game", black, 185, 250)
